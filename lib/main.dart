...
void main() async {
  ...
  ); // debug code, change later. For images displaying and firebase
  //final token = await FirebaseAppCheck.instance.getToken(true);
  //print("Manual debug token: $token");
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MySplashPage(title: 'Recovery AI'),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        // Here we take the value from the MySplashPage object that was created by
